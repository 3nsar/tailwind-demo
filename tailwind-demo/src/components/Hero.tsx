...
const Hero = () => {
  return (
      <div className="h-screen flex items-center  text-gray-200">
        <div className ='text-center mx-auto'>
            ...
            <div className="flex">
                ...
                <button className=' mt-5 ml-2 p-2 pr-5 pl-5 rounded bg-transparent border border-gray-100  hover:border-slate-900 hover:bg-teal-600'>Learn More</button>
            </div>
